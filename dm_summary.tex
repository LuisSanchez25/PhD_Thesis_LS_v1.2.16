...
These findings challenged the prevailing view that luminous matter dominated galaxies and clusters. The accumulating evidence for dark matter revolutionized our understanding of galaxy formation and cosmic structure. While the early indications of dark matter were compelling, to fully appreciate two of the strongest lines of evidence for dark matter, gravitational lensing and the CMB, we must first recall some basics of General Relativity. 
...
In this work, we will first discuss the theory of DM and one of its most promising candidates, the WIMP. We will look at detector technology designed to detect these particles, focusing on the XENONnT experiment, its hardware, and software processing. We need this in order to understand the kinds of signals we wish to detect and how we can improve our chances of detecting DM by improving the signal classification.
...
We also examine XAMS, a small-scale dark matter experiment designed to test the TPC technology on which experiments such as XENONnT are based. This section shows the power of our method to characterize detector signals and flag abnormal data for analysis.
